...
formatDate3 = d3.utcFormat('%Y-%m-%d')
...
const render = (data, nombre_torneo, clubes, puntos_por_partido, data1, fechas_playoff) => {
  ...
  let clasificacion_por_grupo = 8
  let repechaje = false
  let equipos_por_grupos = top_n/grupos
  let width_playoffs = 400
  let height_playoffs = heightBars
  let space_width_playoff = 100
  ...
  console.log(primera_ronda_playoff)

  /* height = height + heightBars */
  ...
  if (grupos > 1) {
    ...
    .attrs({
      class: 'years',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff) + space_width_playoff,
      y: margin.top * 0.8,
    ...
    svg
    .selectAll('.rect')
    .data(yearSlice.slice(0, primera_ronda_playoff))
    .enter()
    .append('rect')
    .attrs({
      class: 'bars_names',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff+space_width_playoff) + space_width_playoff,
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff, 0])(i) + ((top_n*heightBars)/primera_ronda_playoff)/2 - heightBars/2 - height_playoffs/2 - space_height_playoff,
      width: width_playoffs,
      height: height_playoffs
    })
    .styles({
      fill: (d, i) => '#919191',
      opacity: (d, i) => 0.8
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff, 0])(i) + ((top_n*heightBars)/primera_ronda_playoff)/2 - heightBars/2 - space_height_playoff - defaults.logo.size/2,
    ...
    .attrs({
      class: 'years',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff) + space_width_playoff*2 + width_playoffs,
      y: margin.top * 0.8,
      transform: `translate(${margin_left * 2}, 0)`,
    })
    .styles({
    ...
    svg
    .selectAll('.rect')
    .data(yearSlice.slice(0, primera_ronda_playoff/2))
    .enter()
    .append('rect')
    .attrs({
      class: 'bars_names',
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/2, 0])(i) + ((top_n*heightBars)/primera_ronda_playoff) - heightBars/2 - height_playoffs/2 - space_height_playoff,
      width: width_playoffs,
      height: height_playoffs
    })
    .styles({
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/2, 0])(i) + ((top_n*heightBars)/primera_ronda_playoff) - heightBars/2 - space_height_playoff,
    })
    .styles({
      fill: defaults.name.style.fill,
      'font-size': defaults.name.style.font_size,
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/2, 0])(i) + ((top_n*heightBars)/primera_ronda_playoff) - heightBars/2 - space_height_playoff - defaults.logo.size/2,
      height: defaults.logo.size,
      href: d => `./escudos/${d.local.split('-')[0]}.png`
    })
    .style('filter', 'url(#dropshadow)')
    ...
    .attrs({
      class: 'years',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff) + space_width_playoff*3 + width_playoffs*2,
      y: margin.top * 0.8,
      transform: `translate(${margin_left * 2}, 0)`,
    })
    .styles({
    ...
    svg
    .selectAll('.rect')
    .data(yearSlice.slice(0, primera_ronda_playoff/4))
    .enter()
    .append('rect')
    .attrs({
      class: 'bars_names',
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/4, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/2)) - heightBars/2 - height_playoffs/2 - space_height_playoff,
      width: width_playoffs,
      height: height_playoffs
    })
    .styles({
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/4, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/2)) - heightBars/2 - space_height_playoff,
    })
    .styles({
      fill: defaults.name.style.fill,
      'font-size': defaults.name.style.font_size,
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/4, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/2)) - heightBars/2 - space_height_playoff - defaults.logo.size/2,
      height: defaults.logo.size,
      href: d => `./escudos/${d.local.split('-')[0]}.png`
    })
    .style('filter', 'url(#dropshadow)')
    ...
    .attrs({
      class: 'years',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff) + space_width_playoff*4 + width_playoffs*3,
      y: margin.top * 0.8,
      transform: `translate(${margin_left * 2}, 0)`,
    })
    .styles({
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/8, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/4)) - heightBars/2 - height_playoffs/2 - space_height_playoff,
      width: width_playoffs,
      height: height_playoffs
    })
    .styles({
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/8, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/4)) - heightBars/2 - space_height_playoff,
    })
    .styles({
      fill: defaults.name.style.fill,
      'font-size': defaults.name.style.font_size,
    ...
    .attrs({
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/8, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/4)) - heightBars/2 - space_height_playoff - defaults.logo.size/2,
      height: defaults.logo.size,
      href: d => `./escudos/${d.local.split('-')[0]}.png`
    })
    .style('filter', 'url(#dropshadow)')
    ...
    *************************************************************************************************** */
    ...
    .attrs({
      class: 'years',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff) + space_width_playoff*5 + width_playoffs*4,
      y: margin.top * 0.8,
      transform: `translate(${margin_left * 2}, 0)`,
    })
    .styles({
    ...
    .text(playoffs_names[primera_ronda_playoff/16])

    svg
    .selectAll('.rect')
    .data(yearSlice.slice(0, primera_ronda_playoff/16))
    .enter()
    .append('rect')
    .attrs({
      class: 'bars_names',
      ...
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/16, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/8)) - heightBars/2 - height_playoffs/2 - space_height_playoff,
      width: width_playoffs,
      height: height_playoffs
    })
    .styles({
    ...
    svg
    .selectAll('.text')
    .data(fechas_playoff.filter(d => d.fecha == `Fecha 1/${primera_ronda_playoff/16}`).slice(0, primera_ronda_playoff))
    .enter()
    .append('text')
    .attrs({
      class: 'playoffs_names',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff+space_width_playoff) + space_width_playoff*5 + width_playoffs*4 + heightBars*1.2,
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/16, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/8)) - heightBars/2 - space_height_playoff,
    })
    .styles({
      fill: defaults.name.style.fill,
      'font-size': defaults.name.style.font_size,
    ...
    .attrs({
      class: 'playoffs_names',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff+space_width_playoff) + space_width_playoff*5 + width_playoffs*4 + heightBars*0.5 - defaults.logo.size/2,
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/16, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/8)) - heightBars/2 - space_height_playoff - defaults.logo.size/2,
      height: defaults.logo.size,
      href: d => `./escudos/${d.local.split('-')[0]}.png`
    })
    .style('filter', 'url(#dropshadow)')
    ...
    .attrs({
      class: 'playoffs_names',
      x: width - (width_playoffs*rondas_playoff+space_width_playoff*rondas_playoff+space_width_playoff) + space_width_playoff*5 + width_playoffs*4 + heightBars*1.2 + width_playoffs*0.9,
      y: (d, i) => yPlayoffs.domain([primera_ronda_playoff/16, 0])(i) + ((top_n*heightBars)/(primera_ronda_playoff/8)) - heightBars/2 - space_height_playoff,
    })
    .styles({
      fill: defaults.name.style.fill,
 ...
 */
  ...
  svg
    ...
    .text((semana) => {
      ...
      /* console.log(formatDate(parseDate(min_day))) */
      return formatDate(parseDate(min_day))/* filterr.find((d) => d.year == min_day).dia_large *//* .split(' ')[0] + " " + min_day.slice(2,4) */
    })
...
Promise.all([d3.csv('data6.csv')]).then(([data1]) => {
  /* let torneos = [...new Set(data1.map((d) => d.torneo))]
  data1 = data1.filter(d => d.torneo == 'Torneo Inicial 2013') */
